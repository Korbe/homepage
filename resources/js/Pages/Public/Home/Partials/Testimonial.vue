<template>
    <div class="my-20">
        <div class="max-w-4xl">
            <h2 class="text-2xl font-bold tracking-tight text-zinc-800 sm:text-3xl dark:text-zinc-100 my-3">Mein bis
                ...
                <div
                    ...
                    <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                        <figure class="relative isolate pt-6 sm:pt-12">
                            ...
                            <blockquote class="text-xl/8 font-semibold text-zinc-800 dark:text-white sm:text-2xl/9">
