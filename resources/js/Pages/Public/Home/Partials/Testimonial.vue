<template>
    <div class="my-20">
        <div class="max-w-4xl">
            <h2 class="text-2xl font-bold tracking-tight text-brand-headline sm:text-3xl dark:text-brand-headline-dark my-3">Mein bis
                jetzt größtes Projekt!</h2>
                ...
                <div
                    ...
                    <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                        <figure class="relative isolate pt-6 sm:pt-12">
                            ...
                            <blockquote class="text-xl/8 font-semibold text-brand-headline dark:text-white sm:text-2xl/9">
                                <p>{{ testimonial.text }}</p>
                            </blockquote>
                            <figcaption class="mt-8 text-base">
                                <div class="font-semibold text-brand-headline dark:text-white">{{ testimonial.name }}</div>
                                ...
                                <a class="text-brand" href="fcg-villach.at" target="_blank">fcg-villach.at</a>
